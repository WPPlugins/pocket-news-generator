...
= Decrease data size loaded from web server by adopting a lightweight lazy-load library = 
  ...
  This plugin uses a lightweight jQuery plugin created by optimizing Unveil.js (https://github.com/luis-almeida/unveil) 
  less than 0.6KB in size in order to only load an image when it's visible in the viewport.
...
= 0.2.1 =
* Check logic improvement for mobile 
